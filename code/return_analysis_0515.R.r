...
data_590 = read.csv("./data/return/analysis_data/건국대학교 (입학정보관)_590_return_data.csv")
data_591 = read.csv("./data/return/analysis_data/건국대학교 (행정관)_591_return_data.csv")
data_3523 = read.csv("./data/return/analysis_data/건국대학교 과학관(이과대) 앞_3523_return_data.csv")
data_3860 = read.csv("./data/return/analysis_data/건국대학교 정문 앞_3860_return_data.csv")
data_592 = read.csv("./data/return/analysis_data/건국대학교 학생회관_592_return_data.csv")
data_3569 = read.csv("./data/return/analysis_data/건대병원후문_3569_return_data.csv")
data_3579 = read.csv("./data/return/analysis_data/광진 캠퍼스시티_3579_return_data.csv")
data_500 = read.csv("./data/return/analysis_data/어린이대공원역 3번출구 앞_500_return_data.csv")
data_3571 = read.csv("./data/return/analysis_data/화양 APT(횡단보도 옆)_3571_return_data.csv")
data_3582 = read.csv("./data/return/analysis_data/화양동 우체국_3582_return_data.csv")
data_3508 = read.csv("./data/return/analysis_data/화양사거리_3508_return_data.csv")
gu = read.csv("./data/return/analysis_data/광진구_sample_return_data.csv")
dong = read.csv("./data/return/analysis_data/화양동_sample_return_data.csv")
...
write.csv(final_result, "./result/return/test/return_final_result.csv", row.names=F)

# save results
write.csv(rf_train_result, "./result/return/test/return_rf_train_result.csv", row.names=F)
write.csv(rf_val_result, "./result/return/test/return_rf_val_result.csv", row.names=F)
write.csv(rf_best_result, "./result/return/test/return_rf_best_result.csv", row.names=F)
write.csv(rf_test_result_ind, "./result/return/test/return_rf_test_result_ind.csv", row.names=F)
write.csv(rf_test_result_gu, "./result/return/test/return_rf_test_result_gu.csv", row.names=F)
write.csv(rf_test_result_dong, "./result/return/test/return_rf_test_result_dong.csv", row.names=F)

write.csv(elnet_train_result, "./result/return/test/return_elnet_train_result.csv", row.names=F)
write.csv(elnet_val_result, "./result/return/test/return_elnet_val_result.csv", row.names=F)
write.csv(elnet_best_result, "./result/return/test/return_elnet_best_result.csv", row.names=F)
write.csv(elnet_test_result_ind, "./result/return/test/return_elnet_test_result_ind.csv", row.names=F)
write.csv(elnet_test_result_gu, "./result/return/test/return_elnet_test_result_gu.csv", row.names=F)
write.csv(elnet_test_result_dong, "./result/return/test/return_elnet_test_result_dong.csv", row.names=F)

write.csv(xg_train_result, "./result/return/test/return_xg_train_result.csv", row.names=F)
write.csv(xg_val_result, "./result/return/test/return_xg_val_result.csv", row.names=F)
write.csv(xg_best_result, "./result/return/test/return_xg_best_result.csv", row.names=F)
write.csv(xg_test_result_ind, "./result/return/test/return_xg_test_result_ind.csv", row.names=F)
write.csv(xg_test_result_gu, "./result/return/test/return_xg_test_result_gu.csv", row.names=F)
write.csv(xg_test_result_dong, "./result/return/test/return_xg_test_result_dong.csv", row.names=F)
